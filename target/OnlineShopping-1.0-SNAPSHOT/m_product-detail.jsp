                                        ...
                                        <form action="mkt_productdetail" method="post" enctype="multipart/form-data">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="custom-file">
                                                        <input type="file" accept="image/*" class="custom-file-input" id="customFile" name="NewProImgDefault">
                                            ...
                                            <c:forEach items="${productImage}" var="pi" varStatus="loop">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="custom-file">
                                                            <input type="file" accept="image/*" class="custom-file-input" id="customFile" name="newProImage${count}">
